...
- O design do projeto foi elaborado no Figma. O layout pode ser visualizado [aqui](https://www.figma.com/file/i2X1ajPBAZrPi8GMoNLzMF/Teste-Panda-2024?type=design&node-id=0%3A1&mode=dev&t=DU1MO6WIl94oSZaa-1).
...
- app.js: Arquivo JavaScript que inclui lógica para interações na página.


## Instruções de Uso
Na criação do projeto iniciei com [Vite](https://pt.vitejs.dev/guide/) para criação da estrutura de pastas.

-  Faça o clone do repositório e após abrir o terminal na pasta do projeto inicie com:
